...
export default function Std_SubjectItem(props) {
    ...
    return (
        <>
            <div>
                <button className='sub_btn bg-slate-100 w-4/5 m-auto mt-10 rounded-md py-2 flex justify-between text-black items-center hover:bg-slate-200'  onClick={() => handleQns(sub)}  >
                    <div>
